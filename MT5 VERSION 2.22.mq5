//+------------------------------------------------------------------+
//| MA Crossover EA - Hedge + Fixed Lot + Auto-Close Recovery (v2.22)|
//+------------------------------------------------------------------+
...
//=== CONFIG =========================================================
input string  EA_Name               = "MA_Crossover_EA_Hedge_Double_v2_22";
...
void ManageTrades(const ENUM_TRADE_SIGNAL sig)
{
   ...
   // If one position exists -> check if it is negative; if negative open opposite same-size lot and close the original
